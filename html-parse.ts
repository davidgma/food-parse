...
class CronometerDataRow {
    constructor(public meal = "unknown", public time = "unknown", public type = "unknown",
        public name = "unknown", public value = 0, public unit = "unknown",
        public calories = 0) { }
    toString() {
...
mappings.set("Oyster, Pacific", "Oyster");
...
mappings.set("Seaweed, Spirulina", "Seaweed");
...
mappings.set("Beef, Ground, 80% Lean Meat, 20% Fat", "Beef mince");
mappings.set("Beans, Adzuki, Mature Seeds", "Adzuki beans");
mappings.set("Chicken Thigh, Skin Removed", "Chicken");
mappings.set("Fat, goose", "Goose fat");
mappings.set("M&amp;S Count On Us Nacho Chicken Wrap", "M&S Chicken wrap");
mappings.set("Beans, White, Mature Seeds", "White beans");
mappings.set("Whole Wheat Flour", "Wheat");
mappings.set("Barley Flour", "Barley");
mappings.set("Wholemeal strong wheat bread flour dgm", "Wholemeal bread flour");
mappings.set("Bread 65% hydration 08/05/2025", "Homemade bread");
mappings.set("Squidgy bread 13/05/2025", "Homemade bread");
mappings.set("Chocolate Fudge Cake, Not Frosted, Homemade", "Chocolate cake");
mappings.set("Hard Cider", "Cider");
mappings.set("Squidgy bread 19/05/2025", "Homemade bread");
mappings.set("Squash, Winter, Butternut, Cooked, Baked, without Salt", "Butternut squash");
mappings.set("NutriBiotic, Grapefruit Seed Extract", "Grapefruit Seed Extract");
mappings.set("Molasses, Blackstrap", "Molasses");
mappings.set("Popcorn, Home Popped, Hot Air Popped", "Popcorn");
mappings.set("Highland Spring, Still Spring Water", "Highland Spring water");
mappings.set("Capers, canned", "Capers");
mappings.set("Starter at 80% hydration", "Starter");
mappings.set("Rice, Brown, Long-Grain", "Rice - brown");
mappings.set("Paprika Seasoning", "Paprika");
mappings.set("Oil, Olive, Extra Virgin", "Olive oil");
mappings.set("Dried seaweed", "Seeweed");
mappings.set("Cabbage, Green", "Cabbage - green");
mappings.set("Co-op Chicken and Stuffing sandwich", "Chicken sandwich");
mappings.set("Boots Hoisin Duck Wrap", "Duck Wrap");
mappings.set("Brownie, Chocolate", "Chocolate brownie");
mappings.set("Oat Flour, Whole Grain", "Oat flour");
mappings.set("Fudge, Rocky Road, Chocolate, Peanuts, Marshmallows", "Rocky Road");
mappings.set("Beans, French, Mature Seeds, Cooked, Boiled, with Salt", "French beans");
mappings.set("Chips From a Restaurant", "Chips");
mappings.set("Peas, Green, Frozen, Cooked, Boiled, Drained, Without Salt", "Peas");
mappings.set("Apricot, Dried, Uncooked", "Dried Apricots");
mappings.set("Lamb Roast, Rib, Visible Fat Eaten", "Lamb");
mappings.set("Peanut Butter, Smooth Style, with Salt", "Peanut Butter");
mappings.set("Wheat Bran, Crude", "Wheat bran");
mappings.set("Sourdough starter 100% hydration", "Sourdough starter");
mappings.set("Chicken, roasting, dark meat, meat only, cooked, roasted", "Chicken");
mappings.set("", "");
mappings.set("", "");
mappings.set("", "");
mappings.set("", "");
...
// get the data rows
let cronData = new Array<CronometerDataRow>();
